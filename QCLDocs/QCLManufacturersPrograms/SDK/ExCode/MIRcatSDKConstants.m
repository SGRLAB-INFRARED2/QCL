...
%
 MIRcatSDK_COMM_SERIAL                               = uint8(1);
 MIRcatSDK_COMM_UDP                                  = uint8(2);
...
%
 MIRcatSDK_SERIAL_PORT_AUTO                          = uint16(0);
 MIRcatSDK_SERIAL_BAUD_USE_DEFAULT                   = uint32(0);
 MIRcatSDK_SERIAL_BAUD1                              = uint16(115200);
 MIRcatSDK_SERIAL_BAUD2                              = uint16(921600);
...
%
 MIRcatSDK_UNITS_MICRONS                             = uint8(1);
 MIRcatSDK_UNITS_CM1                                 = uint8(2);
...
%
 ...
 MIRcatSDK_MODE_ERROR                                = uint8(0);
 MIRcatSDK_MODE_PULSED                               = uint8(1);
 MIRcatSDK_MODE_CW                                   = uint8(2);
 MIRcatSDK_MODE_CW_MOD                               = uint8(3);
 MIRcatSDK_MODE_CW_MR                                = uint8(6);	% currently not supported in firmware
 MIRcatSDK_MODE_CW_MR_MOD                            = uint8(7);	% currently not supported in firmware
 MIRcatSDK_MODE_CW_FLTR1                             = uint8(8);
 MIRcatSDK_MODE_CW_FLTR2                             = uint8(9);
 MIRcatSDK_MODE_CW_FLTR1_MOD                         = uint8(10);
...
%
 MIRcatSDK_PULSE_MODE_INTERNAL                       = uint8(1);
 MIRcatSDK_PULSE_MODE_EXTERNAL_TRIGGER               = uint8(2);
 MIRcatSDK_PULSE_MODE_EXTERNAL_PASSTHRU              = uint8(3);
 MIRcatSDK_PULSE_MODE_WAVELENGTH_TRIGGER             = uint8(4);
...
%
 MIRcatSDK_PROC_TRIG_MODE_INTERNAL                   = uint8(1);
 MIRcatSDK_PROC_TRIG_MODE_EXTERNAL                   = uint8(2);
 MIRcatSDK_PROC_TRIG_MODE_MANUAL                     = uint8(3);

 save('MIRcatSDKconstants.mat')